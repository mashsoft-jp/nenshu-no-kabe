...
with sync_playwright() as p:
    ...
    for width in [1440, 1024, 768, 390, 320]:
        ...
        check(june_saved['version']==7 and june_saved['input']['residentCollectionMode']=='june','v5 includes collection choice')
        ...
        check(no_withholding['version']==7,'v6 supports no withholding')
        load(page,initial)
